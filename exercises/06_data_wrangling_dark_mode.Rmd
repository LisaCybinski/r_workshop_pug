...
#reorganize the columns, everything exepted previous mentioned things; everything is a function!, sonst everything as column name#
...
#in filter() you can replace "&" with ","
...
```{r}
nerd_red %>% 
  filter(gender == 3 & (married == 2 | married == 3))
```
...
#different from base R, not overwritten#
#== comparison#
...
#across() always when multiplying columns#
#ungroup: if not, it's permanent and it will influence other functions#
